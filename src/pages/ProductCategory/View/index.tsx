...
const ViewProductCategoryPage = () => {
  ...
  const { loadingGetById, viewData, loadingDelete } = useSelector((state: StoreState) => state.productCategories);
  ...
  const currentRoute = allRoutes.find((r) => r.id === 'view-productCategory');
  ...
  const pageTitle = viewData?.name ? `Categoria ${viewData?.name}` : currentRoute?.title ?? '';
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta name="description" content="Visualizar uma categoria de produto" />
      </Helmet>
      <Zoom in>
        <div id="view-productCategory-page" className="p-grid p-align-center">
            ...
            <div className="p-grid">
              <div className="p-col p-grid">
                ...
                <div className="p-col-4">
                  ...
                  <div className="label-value">{viewData.totalProducts}</div>
                </div>
                <div className="p-col-4">
