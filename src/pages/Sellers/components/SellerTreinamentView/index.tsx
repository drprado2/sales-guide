...
const SellerTreinamentView : React.FC<Props> = ({ treinaments }) => {
          ...
          localTreinaments.map((t) => (
            <>
              <ListItem key={t.product}>
                ...
                <ListItemText primary={`Treinamento do produto ${t.product}`} secondary={`Concluído ${format(t.date, "dd/MM/yyyy HH:mm'h'")}`} />
...
export default SellerTreinamentView;
