...
const EditZonePage = () => {
  ...
  const currentRoute = allRoutes.find((r) => r.id === 'edit-zone');
  ...
  const pageTitle = viewData?.name ? `Editando região ${viewData.name}` : currentRoute?.title ?? '';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Editar uma região" />
      </Helmet>
      <Zoom in>
