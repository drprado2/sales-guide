...
import {
  ProductCategory,
  ProductCategoryList, ProductCategoryOption,
...
const initialState: ProductCategoryState = {
  ...
  createForm: {
    ...
    icon: { value: '', validations: [required], errors: [] },
  },
  updateForm: {
...
const slice = createSlice({
  ...
  reducers: {
    ...
    onGetListSuccess(
      state,
      action: PayloadAction<PaginatedResponse<ProductCategoryList>>,
    ) {
    ...
    onGetOptionsSuccess(
      state,
      action: PayloadAction<Array<ProductCategoryOption>>,
    ) {
    ...
    onGetByIdSuccess(
      ...
      state.updateForm.icon.value = action.payload.icon;
    },
